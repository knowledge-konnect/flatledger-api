namespace SocietyLedger.Application.Interfaces.Repositories
{
    public interface IAdjustmentRepository
    {
        ...
        /// </summary>
        Task<IReadOnlyList<AdjustmentLedgerEntry>> GetByFlatIdAsync(long flatId, long societyId, DateTime? startDate, DateTime? endDate);
        ...
        /// </summary>
        Task<decimal> GetOpeningBalanceRemainingAsync(long flatId, long societyId);
    }
