    ...
    internal static class EntityMappers
    {
        ...
        public static Flat ToDomain(this flat entity)
        {
            return new Flat
            {
                ...
                TenantMobile = entity.tenant_mobile,
                TenantEmail = entity.tenant_email,
        ...
        public static flat ToEntity(this Flat domain)
        {
            return new flat
            {
                ...
                tenant_name = domain.TenantName,
                tenant_mobile = domain.TenantMobile,
                tenant_email = domain.TenantEmail,
